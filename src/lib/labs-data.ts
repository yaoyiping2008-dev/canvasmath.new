...
export const labsData: LabModule[] = [
  ...
  {
    id: "10",
    title: "Sudoku Deduction",
    slug: "sudoku-deduction",
    moduleEndpoint: "https://pocketjoso.github.io/sudokuJS/",
    image: "/thumbnails/lab-10.png",
    category: "Logic & Reasoning",
    seoTitle: "Sudoku Deduction - Logic Grid Module | CanvasMath",
    seoDescription:
      "Solve sudoku grids using deductive reasoning and constraint-based elimination.",
    subject: "Logic & Reasoning",
    gradeBand: "Grades 6-12",
    difficulty: "Intermediate",
    estimatedMinutes: 20,
    summary: "Classic sudoku puzzles for logical deduction practice.",
    learningObjectives: [
      "Apply elimination strategies on constrained grids",
      "Justify cell assignments with logical rules",
    ],
    skills: ["Deductive reasoning", "Constraint analysis"],
    sourceUrl: "https://pocketjoso.github.io/sudokuJS/",
    embedMode: "iframe",
  },
  {
    id: "12",
  ...
  },
  {
    ...
    slug: "hexagonal-number-puzzle",
    moduleEndpoint: "https://michaelfbastos.github.io/hex%20puzzle/",
    image: "/thumbnails/lab-15.png",
    category: "Logic & Reasoning",
    seoTitle: "Hexagonal Number Puzzle - Spatial Number Module | CanvasMath",
    seoDescription:
      "Arrange numbered hexagonal tiles to satisfy adjacency constraints in a spatial puzzle.",
    subject: "Logic & Reasoning",
    gradeBand: "Grades 6-12",
    difficulty: "Advanced",
    estimatedMinutes: 20,
    summary: "External hexagonal tile puzzle requiring spatial and numeric planning.",
    learningObjectives: ["Plan multi-step tile placements under constraints"],
    skills: ["Spatial reasoning", "Constraint satisfaction"],
    sourceUrl: "https://michaelfbastos.github.io/hex%20puzzle/",
    embedMode: "iframe",
  },
  {
    id: "16",
  ...
  {
    id: "17",
    title: "Proportions 3D",
    slug: "proportions-3d",
    moduleEndpoint:
      "https://phet.colorado.edu/sims/html/proportions-3d/latest/proportions-3d_all.html",
    image: "/thumbnails/lab-17.png",
    category: "Algebra",
    seoTitle: "Proportions 3D - Ratio and Scale Simulation | CanvasMath",
    seoDescription:
      "Explore ratios and proportional relationships using interactive 3D scale models.",
    subject: "Algebra",
    gradeBand: "Grades 6-8",
    difficulty: "Intermediate",
    estimatedMinutes: 20,
    summary: "Manipulate 3D models to study ratio, scale, and proportional reasoning.",
    learningObjectives: [
      "Compare ratios in scaled models",
      "Predict changes when dimensions scale proportionally",
    ],
    skills: ["Ratio reasoning", "Proportional thinking"],
    publisher: "PhET Interactive Simulations",
    sourceUrl: "https://phet.colorado.edu/en/simulations/proportions-3d",
    embedMode: "iframe",
  },
  {
    id: "18",
    title: "Grid Matrix Puzzle",
    slug: "grid-matrix-puzzle",
    moduleEndpoint: "https://stared.github.io/matrix-game/",
    image: "/thumbnails/lab-18.png",
    category: "Logic & Reasoning",
    seoTitle: "Grid Matrix Puzzle - Transformation Planning Module | CanvasMath",
    seoDescription:
      "Plan grid transformations to reach target arrangements in a matrix-style puzzle activity.",
    subject: "Logic & Reasoning",
    gradeBand: "Grades 6-12",
    difficulty: "Advanced",
    estimatedMinutes: 20,
    summary: "External grid puzzle requiring step planning to match target matrix patterns.",
    learningObjectives: ["Sequence operations to transform a grid state"],
    skills: ["Algorithmic planning", "Pattern matching"],
    sourceUrl: "https://stared.github.io/matrix-game/",
    embedMode: "iframe",
  },
  {
    id: "19",
